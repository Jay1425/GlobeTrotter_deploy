...
app.config.update(
	...
	# Session cookie settings for reliable OAuth state on localhost
	...
	MAIL_DEFAULT_SENDER='aivisionaries.teams@gmail.com',
...
# Google OAuth setup - USE ENVIRONMENT VARIABLES
google_client_id = os.environ.get('GOOGLE_CLIENT_ID')
google_client_secret = os.environ.get('GOOGLE_CLIENT_SECRET')

if not google_client_id or not google_client_secret:
	print("WARNING: GOOGLE_CLIENT_ID and GOOGLE_CLIENT_SECRET not set")
...
def dashboard():
	...
	if verification_redirect:
		flash("Please verify your email address to access your dashboard.", "warning")
	...
	# User is verified, proceed with dashboard
		...
		total_trips = completed_trips = upcoming_trips = places_visited = 0
		total_budget = avg_budget = 0
		recent_trips = []
		next_trip = None
		recommended_destinations = []
